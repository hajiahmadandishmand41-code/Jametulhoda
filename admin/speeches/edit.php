        ...
        if (!$title) {
            ...
            if (!$error) {
                try {
                    ...
                    redirect(siteUrl('admin/speeches/edit.php?id=' . $id));
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="<?= siteUrl('speech.php?slug=' . urlencode($post['slug'])) ?>" target="_blank" class="btn btn-sm btn-outline-success"><i class="bi bi-eye ms-1"></i>مشاهده</a>
