        ...
        <div class="col-12"><div class="announcement-card d-flex gap-4 align-items-start">
            ...
            <div class="flex-grow-1">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                    <h4 class="announcement-title mb-1"><a href="<?= siteUrl('post.php?slug=' . urlencode($p['slug'])) ?>"><?= sanitize($p['title']) ?></a></h4>
                ...
                <a href="<?= siteUrl('post.php?slug=' . urlencode($p['slug'])) ?>" class="btn btn-sm btn-outline-warning">ادامه مطلب <i class="bi bi-arrow-left ms-1"></i></a>
            </div>
        </div></div>
        <?php endforeach; ?>
    </div>
