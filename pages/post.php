...
$typeMap=['news'=>['label'=>'اخبار','url'=>siteUrl('news')],'article'=>['label'=>'مقالات','url'=>siteUrl('articles')],'research'=>['label'=>'پژوهش‌ها','url'=>siteUrl('research')],'report'=>['label'=>'گزارش‌ها','url'=>siteUrl('reports')],'announcement'=>['label'=>'اطلاعیه‌ها','url'=>siteUrl('announcements')],'qa'=>['label'=>'پرسش و پاسخ','url'=>siteUrl('qa')]];
