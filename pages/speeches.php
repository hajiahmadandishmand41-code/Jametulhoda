...
function speechPageUrl(int $p): string {
    $q = $_GET;
    $q['page'] = $p;
    return siteUrl('speeches') . '?' . http_build_query($q);
}
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="<?= siteUrl('speeches' . ($search ? '?q=' . urlencode($search) : '')) ?>"
                            ...
                            <li>
                                ...
                                $catUrl   = siteUrl('speeches') . '?' . http_build_query($catQuery);
                                ?>
                    ...
                    <div class="sidebar-widget mt-3">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                ...
                                $yUrl   = siteUrl('speeches') . '?' . http_build_query($yQuery);
                                ?>
