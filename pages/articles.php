  ...
  <div class="container">
    ...
    <form method="get" class="mb-5">
      <div class="input-group" style="max-width:440px">
        ...
        <?php if ($search): ?>
        <a href="<?= siteUrl('articles') ?>" class="btn btn-outline-secondary">
          <i class="bi bi-x"></i>
        </a>
        <?php endif; ?>
      </div>
    ...
    <div class="text-center py-5">
      ...
      <?php if ($search): ?>
      <a href="<?= siteUrl('articles') ?>" class="btn btn-outline-primary mt-3">
    ...
    <div class="mt-5">
      <?= paginate($total, $limit, $page,
          siteUrl('articles') . '?q=' . urlencode($search) . '&page=%d') ?>
    </div>
    <?php endif; ?>
    <?php endif; ?>
  </div>
