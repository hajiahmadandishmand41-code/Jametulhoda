...
- **محدودیت باقی‌مانده:** تعویض فایل در بعضی فرم‌های edit هنوز حذف فایل قبلی را پیش از نهایی‌شدن UPDATE انجام می‌دهد؛ rollback کامل تغییر محتوا/رسانه و reconciliation فایل‌های بدون مرجع باید تکمیل شود.
