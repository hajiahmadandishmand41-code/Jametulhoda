...
4. تکمیل transaction و recovery در تمام فرم‌های ویرایش/آپلود چندتایی؛ بعضی editها فایل قبلی را پیش از UPDATE حذف می‌کنند و بعضی uploadهای جزئی می‌توانند فایل بدون مرجع باقی بگذارند. outbox فعلی فقط حذف content را پوشش می‌دهد.
